...
if (isset($_SESSION['message'])) {
    // Display the message and then clear it
    echo $_SESSION['message'];
    unset($_SESSION['message']); // Clear the message so it doesn't show again on page refresh
}

// Check if the session variable for the profile picture is set
$profilePicture = isset($_SESSION['profile_picture']) ? $_SESSION['profile_picture'] : null;
$profilePicturePath = $profilePicture ? "uploaded_files/" . $profilePicture : "path/to/default/profile/picture.jpg"; // Use a default picture if none uploaded
...
<div class="profile-page">
    ...
    <h2>User Profile</h2>
        ...
        <form id="uploadForm" enctype="multipart/form-data" method="POST" action="upload_profile_picture.php">
            <input type="file" name="profile_picture" id="profileImageInput" accept="image/*" style="display: none;" onchange="previewImage(event)">
